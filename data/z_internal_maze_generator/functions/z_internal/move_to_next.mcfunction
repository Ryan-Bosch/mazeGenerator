...
execute if score mg_random mg_var matches 1 facing ^1 ^ ^ positioned ^ ^ ^1 run function z_internal_maze_generator:z_internal/handle_next
execute if score mg_random mg_var matches 2 facing ^-1 ^ ^ positioned ^ ^ ^1 run function z_internal_maze_generator:z_internal/handle_next
